<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}" class="max-w-md pt-2 mx-auto">
        ...
        <button class="flex items-center px-4 py-2 text-sm font-medium border border-transparent shadow-md dark:bg-blue-600 dark:text-white focus:outline-none hover:bg-blue-700 ">
