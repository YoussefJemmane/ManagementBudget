        ...
        <div class="border rounded-md bg-white p-[20px]  w-[1000px]">
            <form method="POST" action="{{ route('formulaireanalyse.store') }}" class=" pt-4 w-[900px] mx-auto">
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    ...
                    <!-- Semi Designation -->
                    <div class="relative z-0 w-full mb-5 group">
                        <select onchange="updateModeFacturation()" name="semidesignation" id="semidesignation" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-dark dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" id="semidesignation" autofocus required>
                            <option value="">
                ...
                <!-- Mode de Facturation -->
                <div class="relative z-0 w-full mb-5 group">
                    <input id="mode_facturation" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-dark dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" type="text" name="mode_facturation" :value="old('mode_facturation')"  autofocus readonly />
