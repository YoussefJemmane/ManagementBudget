        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    @if (!Auth::user()->hasRole('Pole de recherche|Directeur de laboratoire|Centre d\'appui|Centre d\'analyse'))
                    ...
                    @if (Auth::user()->hasRole('Centre d\'appui'))
                        <div class="flex justify-center">
                            <livewire:chart-appui-centre />
                        </div>
                    @endif
                    @if (Auth::user()->hasRole('Centre d\'analyse'))
                        <div class="flex justify-center">
                            <livewire:chart-analyse-centre />
                        </div>
                    @endif
                </div>
            </div>
